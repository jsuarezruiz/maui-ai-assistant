...
namespace MAUI_AI_Assistant
{
    ...
    [ProvideOptionPage(typeof(OptionsProvider.UnitTestOptions), ".NET MAUI AI Assistant", "Unit Testing", 1, 1, true, SupportsProfiles = true)]
    [ProvideOptionPage(typeof(OptionsProvider.CustomCommandOptions), ".NET MAUI AI Assistant", "Custom Command", 2, 2, true, SupportsProfiles = true)]
